...
pickledX = '/home/flexor/smartparking/IoT-Assets/variables/pickledX.x'
pickledY = '/home/flexor/smartparking/IoT-Assets/variables/pickledY.y'
...
pickledModelPath = '/home/flexor/smartparking/IoT-Assets/pickeled_model.sav'
...
# sensitivity = -40
  ...
  if highest > sensitivity:
    ...
    print("WE DELETED THAT FUCKING FILE! because it was ...")
    print("PROPERLY FUCKING PROCESSED!")
  else:
    os.system("rm " + filename)
    print("WE DELETED THAT FUCKING FILE! because it was ...")
...
path_to_watch = '/home/flexor/Music/buffer/'
print('Your folder path is"',path_to_watch,'"')
print("HOLY LIVING FUCK!!!")
while True:
    ...
    if len(new) > 1:
        ...
        new.sort()
        print(new)
        stupidfuckingfile = path_to_watch + new[0]
        print(stupidfuckingfile)
        print("THIS FILE SHOULD BE FINISHED RECORDING!")
        checkVolumePredict(stupidfuckingfile, -10) #Determines decibel threshold

    else:
        print("THERE WERE ONE OR FEWER FILES HERE!")
        os.system("sleep 1")
